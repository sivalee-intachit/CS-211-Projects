...
/**
 * Concrete class that inherits from LectureCourse and represents online courses.
...
public class HybridCourse extends LectureCourse {
	 ...
	 */
	public HybridCourse(String crn, String title, Set<String> levels, String instructor, int credit,
